...
public class My01Controller {
    ...
    public String mainPage(Model model) {
        List<String> pageNames = List.of("model", "model_ex1", "increase", "fragments", "if-unless", "DTO_ex1", "DTO_ex2", 
    ...
    @GetMapping("/model_ex1")
    public String ex011(Model model){
        model.addAttribute("test1", "안녕하세요");
        model.addAttribute("test2", "감사해요");
        model.addAttribute("test3", "잘 있어요");
        return "ex011"; // templates/ex011.html
     }
    @GetMapping("/increase")
    ...
    public String ex06(Model model){
        ...
        List<BungBbang> bungs = List.of(
          ...
          new BungBbang("타코붕어빵", 1300, LocalDate.of(2025, 6, 2)),
          new BungBbang("피자붕어빵", 1400, LocalDate.of(2025, 6, 2))
        );
